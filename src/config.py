...
ENEMY_KILLED_EVENT = pygame.USEREVENT + 3
GAME_OVER_EVENT = pygame.USEREVENT + 4
...
# Wave properties.
ENEMY_VEL_INCREMENT = 0.2
PLAYER_FIRE_ANIMATION_SPEED_INCREMENT = 0.5
WAVE_1_ENEMY_COOLDOWN = 4  # Seconds.
WAVE_2_ENEMY_COOLDOWN = 3
WAVE_3_ENEMY_COOLDOWN = 2
WAVE_4_ENEMY_COOLDOWN = 1
WAVE_5_ENEMY_COOLDOWN = 0.5  # Endless after wave 5.
WAVE_CHANGE_TIME = 30000  # Ms.
